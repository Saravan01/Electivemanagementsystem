...
if($ret)
{
$_SESSION['msg']="Elective Created Successfully !!";
}
else
{
  $_SESSION['msg']="Error : Elective not created";
}
}
if(isset($_GET['del']))
      {
              mysqli_query($con,"delete from course where id = '".$_GET['id']."'");
                  $_SESSION['delmsg']="Elective deleted !!";
      }
?>
...
<font color="green" align="center"><?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?></font>
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" id="coursename" name="coursename" placeholder="Elective Name" required />
  </div>

<div class="form-group">
    <label for="courseunit">Elective unit  </label>
    <input type="text" class="form-control" id="courseunit" name="courseunit" placeholder="Elective Unit" required />
  </div> 
